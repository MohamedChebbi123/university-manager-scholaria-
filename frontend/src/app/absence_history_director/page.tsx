...
export default function DirectorAbsenceHistoryPage() {
  const router = useRouter()
  const [role, setRole] = useState<string>("")
  const [absencesData, setAbsencesData] = useState<DirectorAbsenceData | null>(null)
  ...
  useEffect(() => {
    const fetchData = async () => {
      ...
      try {
        ...
        const data: DirectorAbsenceData = await response.json()
        ...
        <div className="container mx-auto max-w-7xl">
          ...
          <div className="mb-8">
            ...
            <p className="text-gray-600">
              Director: {absencesData.director_name}
            </p>
          </div>
