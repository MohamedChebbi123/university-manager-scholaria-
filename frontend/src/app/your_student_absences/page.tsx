...
interface ProfessorAbsenceData {
  professor_id: number
...
export default function ProfessorSubjectAbsencesPage() {
  const router = useRouter()
  const [role, setRole] = useState<string>("")
  const [absencesData, setAbsencesData] = useState<ProfessorAbsenceData | null>(null)
  ...
  useEffect(() => {
    const fetchData = async () => {
      ...
      if (storedRole !== "professor") {
        setError("Access denied. Professors only.")
        setLoading(false)
        return
      }
      ...
      try {
        ...
        const data: ProfessorAbsenceData = await response.json()
        ...
        <div className="container mx-auto max-w-7xl">
          ...
          <div className="mb-8">
            <h1 className="text-4xl font-bold bg-clip-text text-transparent bg-gradient-to-r from-gray-800 via-blue-800 to-purple-800 mb-2">
              Student Absences by Subject
            </h1>
            <p className="text-gray-600">
              Professor: {absencesData.professor_name}
            </p>
          </div>
              ...
              <div key={subject.subject_id} className="bg-white rounded-xl shadow-lg border border-gray-100 overflow-hidden">
                ...
                <div className="bg-gradient-to-r from-indigo-600 to-purple-600 px-6 py-6 text-white">
                  ...
                  <div className="flex flex-wrap gap-4 text-sm">
                    <span className="bg-blue bg-opacity-20 px-3 py-1 rounded-full">
